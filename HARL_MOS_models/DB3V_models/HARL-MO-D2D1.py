    ...
    for epoch in range(num_epochs):
        ...
        if val_acc1 > best_avg_val_acc_1:
            if val_acc2 > best_avg_val_acc_2:
                ...
                torch.save(best_model_wts, "Resnet_GM_OverS_d1_best_avg_val.pth")
...
#     #                     data_loaders['test_region1'], data_loaders['test_region2'], num_epochs=50, save_epoch=50)
#     model.eval()
#     model.load_state_dict(
#         torch.load("Resnet_GM_OverS_d1_best_avg_val.pth"))
#
#     # 开始训练
