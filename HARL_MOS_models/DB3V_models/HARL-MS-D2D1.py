...
def load_data(region_paths, bird_classes):
    ...
    data_loaders['test_region1'] = DataLoader(test_dataset_region2, batch_size=32, shuffle=False, drop_last=False)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc1 > best_avg_val_acc_1:
            if val_acc2 > best_avg_val_acc_2:
                ...
                torch.save(best_model_wts, "Resnet_GM_Mixstyle_d1_best_avg_val_renew_lr_1e_8h_0.4.pth")
...
#                         data_loaders['test_region3'], data_loaders['test_region2'], num_epochs=50, save_epoch=50)
    model.eval()
    model.load_state_dict(
        torch.load("Resnet_GM_Mixstyle_d3_best_avg_val_renew_lr_1e_8h_0.4.pth"))
#
#     # 开始训练
